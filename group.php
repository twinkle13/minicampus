...
$_SESSION['g_id']="58424b39f8f888d40c000029";
?>
...
<img src="images/education.png" style="padding-top:200px;float:left;height:70%;width:60%">
<br clear="all">
...
<div id="wrapper" style="margin-top:10px;">
    ...
    <div class="newstape"  style="width:90%">
        <div class="newstape-content" style="width:30%">
...
<div style="padding-top:80px">
 <div class="common_box2" style=";margin-left:220px ;width:45%">
...
?>
<div id="wrapper" style="margin-top:10px; width:95%">
	<div class="newstape" style="width:95%">
		<div class="newstape-content" style="width:50%">
<?php
...
<div >
<img src="images/accesoElearning.png" style="float:right;height:50%;width:35%;padding-top:100px">
</div>
</div>
 <br clear="all"> 
